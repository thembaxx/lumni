...
Commit baseline: `169d3704` (previous batch was `7525d6ed`, all 56 prior plans DONE).

## Batch 3 — Direction / Feature Plans
...
- Plans within each phase are independent and can be parallelized. Batch 3: 057, 058, 060, 061 are independent. 059 (leaderboard) depends on 058 (cross-device sync) because leaderboard data must reach Appwrite before the Realtime subscription is meaningful.
