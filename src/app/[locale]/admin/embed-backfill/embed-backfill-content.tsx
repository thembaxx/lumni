  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      ...
      <p className="text-muted-foreground text-sm">
        Generate embeddings for past paper questions that don't have them yet. Respects Gemini rate
        limits (~5/min).
      </p>
      ...
      <Card>
        ...
        <CardContent>
          {isError ? (
            <p className="text-destructive text-sm">Failed to load stats: {error?.message}</p>
          ) : isLoading ? (
