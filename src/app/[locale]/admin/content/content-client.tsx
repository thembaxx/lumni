...
export function ContentClient() {
  ...
  return (
    <div className="min-h-dvh bg-background" suppressHydrationWarning>
      <PageHeader title="Content Moderation" subtitle="Review flagged questions" />
                ...
                {flags.map((flag) => (
                  <TableRow key={flag.$id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          (reasonColors[flag.reason] as "destructive" | "outline" | "secondary") ||
                          "secondary"
                        }
                      >
                        {flag.reason}
                    ...
                    <TableCell className="text-xs">{formattedDates[flag.$id] || "..."}</TableCell>
                    <TableCell>
                      <Badge
                        variant={
