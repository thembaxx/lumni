				...
				<div className="prose prose-sm dark:prose-invert max-w-none">
					...
					<section className="flex flex-col gap-4">
						...
						<p className="text-muted-foreground">
							By using Lumni, you agree to these terms. If you do not agree,
						...
						<p className="text-muted-foreground">
							...
							for all activity under your account. Users under 18 require
							parental consent.
						</p>

						<h2 className="font-semibold text-lg">3. Subscription & Billing</h2>
						<p className="text-muted-foreground">
							Premium subscriptions are billed monthly. You may cancel at any
							time. Cancelled subscriptions remain active until the end of the
						...
						<p className="text-muted-foreground">
							Lumni provides study tools and practice materials. We do not
							guarantee exam results. The service is provided &ldquo;as
