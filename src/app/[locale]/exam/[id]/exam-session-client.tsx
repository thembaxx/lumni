...
export function ExamSessionWithResume({ id, mode }: ExamSessionClientProps) {
  ...
  const [resumeData, setResumeData] = useState<Awaited<ReturnType<typeof hasSavedSession>>>(null);
...
function ExamSessionClient({ id, mode }: ExamSessionClientProps) {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    setPhase("results");
  }, [flatParts, answers, completeSession, paperData, quizResultDeps, trackExamComplete]);
