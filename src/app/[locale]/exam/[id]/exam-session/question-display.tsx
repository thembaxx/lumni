        ...
        {currentPart && (
          ...
          >
            ...
            <div className="text-base leading-relaxed">
              {currentPart.part.text && <MarkdownRenderer content={currentPart.part.text} />}
            </div>

            <div className="pt-2">
              <SessionPartAnswerInput
                part={currentPart.part}
                value={currentPartId ? (answers[currentPartId]?.value ?? "") : ""}
                onChange={onAnswer}
                disabled={paused}
              />
            </div>
            ...
            <div className="flex items-center border-border border-t pt-4">
              {isMock ? (
                ...
                <Button variant="outline" onClick={onPrevious} disabled={currentPartIndex <= 0}>
