...
import { useAnswerTracking, useTabFocusWarning } from "./answer-tracking";
import { useAutoSave } from "./auto-save";
import { useQuizResultDeps } from "./gamification-wiring";
import { useResumeSession } from "./resume-session";
import type { ExamSessionClientProps, SessionPhase } from "./session-reducer";
import { useTimeExpiryHandler, useTimerEffect } from "./timer-logic";
...
function ExamSessionClient({ id, mode }: ExamSessionClientProps) {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    setPhase("results");
  }, [flatParts, answers, completeSession, paperData, quizResultDeps, trackExamComplete, timerRef]);
