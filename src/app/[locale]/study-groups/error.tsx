...
export default function StudyGroupsError({
  error,
  reset,
}: {
  ...
  return (
    <div className="grid min-h-dvh place-items-center bg-system-grouped p-6">
      <div className="flex max-w-md flex-col items-center gap-6 text-center">
        ...
        <div>
          <h1 className="ios-title-2 text-foreground">Study groups unavailable</h1>
          <p className="ios-callout mt-1 text-muted-foreground">
            Something went wrong loading study groups. Please try again.
          </p>
        </div>
