    ...
    >
      <div className="p-5">
        <div className="mb-3 flex items-center justify-between gap-3">
          <Badge variant="outline" className={cn("border-0 font-mono text-xs", difficultyColor)}>
            {problem.difficulty}
          </Badge>
          <span className="font-mono text-muted-foreground/50 text-xs">#{index + 1}</span>
        </div>
        ...
        >
          ...
          <HugeiconsIcon
            ...
            className={cn("size-3 transition-transform", showSolution && "rotate-180")}
            data-icon
          />
        </Button>
        ...
        <Anim>
              ...
              {selectedSubject && (
                <div className="scrollbar-hide flex items-center gap-2 overflow-x-auto">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    <span className="text-muted-foreground/50 text-xs">Problems:</span>
                    {[3, 5, 10].map((n) => (
                      <Button
                        key={n}
          ...
          <AnimatePresence mode="wait" initial={false}>
            ...
            {isPending && (
              ...
              >
                {[1, 2, 3].map((i) => (
                  <Skeleton key={`skeleton-${i}`} className="flex flex-col gap-3 rounded-2xl p-5">
