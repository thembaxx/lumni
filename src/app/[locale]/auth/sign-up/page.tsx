  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        <h1 className="ios-title-2 font-semibold text-foreground">{t("auth.createAccount")}</h1>
        <p className="ios-subhead text-muted-foreground">{t("auth.signUpSubtitle")}</p>
      </div>

      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-1.5">
          <label htmlFor="name" className="ios-footnote font-semibold text-foreground">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="ios-caption-1 mt-1 text-muted-foreground">{t("auth.passwordHint")}</p>
        </div>

        {error && <p className="ios-footnote font-medium text-destructive">{error}</p>}
