...
export class WhisperService {
  ...
  async transcribe(audioBlob: Blob, language?: string): Promise<WhisperResult | null> {
  ...
  assessPronunciation(studentText: string, expectedText: string): PronunciationAssessment {
  ...
  private async downloadModelWithProgress(url: string): Promise<ArrayBuffer | null> {
    try {
