...
const getMasteryLevel = (interval: number) => flashcardEngine.getMasteryLevel(interval);
const getIntervalLabel = (interval: number) => flashcardEngine.getIntervalLabel(interval);
