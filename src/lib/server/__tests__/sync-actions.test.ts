...
describe("syncSubject", () => {
  test("returns auth error when not authenticated", async () => {
    mockUserId = null;
    await expect(syncSubject("mathematics")).rejects.toThrow("Authentication required");
  });
...
describe("checkSubjectStatus", () => {
  test("returns not-exists when not authenticated", async () => {
    mockUserId = null;
    await expect(checkSubjectStatus("mathematics")).rejects.toThrow("Authentication required");
  });
...
describe("refreshSubject", () => {
  test("returns auth error when not authenticated", async () => {
    mockUserId = null;
    await expect(refreshSubject("mathematics")).rejects.toThrow("Authentication required");
  });
