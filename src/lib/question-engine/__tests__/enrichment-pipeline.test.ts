...
const { selectAdaptiveQuestions: mockSelectAdaptive } = await import(
	"@/lib/question-engine/adaptive-selector"
);
const { recordSeenQuestions: mockRecordSeen } = await import(
	"@/lib/question-engine/adaptive-selector"
);
