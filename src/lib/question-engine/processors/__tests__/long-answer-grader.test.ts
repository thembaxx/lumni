	...
	return {
		...
		body: {
			rubric: [
				...
				{ name: "Evidence", description: "Uses specific examples", maxScore: 5 },
				{ name: "Analysis", description: "Shows analytical thinking", maxScore: 5 },
			],
			modelAnswer: "The causes of WWII include the Treaty of Versailles, the rise of fascism, and economic depression...",
			minWords: 50,
			maxWords: 500,
		},
		...overrides,
