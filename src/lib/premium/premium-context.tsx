...
interface PremiumContextValue {
  ...
  createCheckoutSession: (billing?: "monthly" | "yearly") => Promise<string | null>;
...
export function PremiumProvider({ children }: { children: React.ReactNode }) {
  ...
  const createCheckoutSession = useCallback(
    async (billing: "monthly" | "yearly" = "yearly"): Promise<string | null> => {
      try {
  ...
  const createPayfastCheckoutSession = useCallback(
    async (
      ...
      try {
        ...
        const itemName = billing === "monthly" ? "Lumni Premium Monthly" : "Lumni Premium Yearly";
