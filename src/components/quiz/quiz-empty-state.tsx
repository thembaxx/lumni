...
function QuizEmptyStateNoQuestions({ subject, onBack }: QuizEmptyStateNoQuestionsProps) {
  const t = useTranslations();
  return (
    <Empty>
      <div className="grid grid-cols-12 items-center gap-4">
...
export function QuizSubjectPrompt({ onSelect, hasSubject }: QuizSubjectPromptProps) {
  const t = useTranslations();
  return (
        ...
        <div className="col-span-12 md:col-span-6">
          <div className="flex flex-col gap-4 text-center md:text-left">
            ...
            <p className="text-muted-foreground/60 text-xs">
              {hasSubject ? t("quiz.pressPlayToStart") : t("quiz.chooseSubjectToStart")}
            </p>
          </div>
        </div>
