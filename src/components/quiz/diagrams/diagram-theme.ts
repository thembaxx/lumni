...
const LIGHT: DiagramColors = {
  ...
  accent: "oklch(58% 0.22 235)",
  chart1: "oklch(55% 0.14 170)" /* Teal — matches success */,
  chart2: "oklch(60% 0.13 170)" /* Teal-light */,
  chart3: "oklch(59% 0.16 50)" /* Cool amber — matches warning */,
  chart4: "oklch(55% 0.14 235)" /* Slate blue — matches accent */,
  chart5: "oklch(56% 0.18 350)" /* Cool coral — matches destructive */,
  chart6: "oklch(52% 0.14 302)" /* Purple — kept for variety */,
  line: "oklch(70% 0 0)",
...
const DARK: DiagramColors = {
  ...
  chart4: "oklch(68% 0.18 235)",
  chart5: "oklch(70% 0.19 350)",
