...
export function MatchPairsInput({ leftItems, rightItems, onSubmit }: MatchPairsInputProps) {
  ...
  const handleRightDragOver = useCallback((e: React.DragEvent, _rightId: string) => {
    e.preventDefault();
