    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <FieldGroup>
            <Field>
              <FieldLabel htmlFor="name">{t("studyGroups.groupName")}</FieldLabel>
              <Input
                id="name"
                value={name}
            ...
            <Field>
              <FieldLabel htmlFor="description">{t("studyGroups.description")}</FieldLabel>
              <Textarea
                id="description"
                value={description}
            ...
            <Field>
              <FieldLabel htmlFor="subject">{t("studyGroups.subject")}</FieldLabel>
