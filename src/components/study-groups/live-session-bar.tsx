...
function ParticipantAvatar({ participant }: { participant: LiveSessionParticipant }) {
...
function ParticipantAvatars({ participants }: { participants: LiveSessionParticipant[] }) {
  ...
  return (
    <div
      className={cn(
        ...
        isActive ? "border-green-400/30 bg-green-500/5" : "border-border bg-card",
      )}
    >
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            <HugeiconsIcon
              ...
              className={cn("size-5", isActive ? "text-green-500" : "text-muted-foreground/50")}
              data-icon
            />
            {isActive && (
