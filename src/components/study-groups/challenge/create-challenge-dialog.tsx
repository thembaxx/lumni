...
export function CreateChallengeDialog({ groupId, onCreated }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button variant="outline" size="sm" />}>New Challenge</DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Create Group Challenge</DialogTitle>
          <DialogDescription>Choose a challenge type for your group this week.</DialogDescription>
        </DialogHeader>
