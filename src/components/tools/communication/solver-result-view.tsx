...
export function SolverResultView({ subject, result, onReset }: SolverResultViewProps) {
  ...
  return (
    <div className="animate-fade-in-up px-5 pb-10">
      ...
      <Button variant="outline" onClick={onReset} className="mt-2 h-10 w-full gap-2 rounded-xl">
