...
import { elementCategoryConfig, elementEaseOutQuint } from "@/lib/data/element-categories";
  ...
  ({
    ...
    return (
      <m.button
        ...
        className={`${config?.bg} relative flex aspect-square cursor-pointer flex-col items-center justify-center rounded-2xl border border-white/10 p-2 text-white transition-[scale] duration-150 active:scale-[0.96] dark:border-white/20`}
      >
