...
const AiSolver = dynamic(() => import("../communication/ai-solver").then((mod) => mod.AiSolver), {
  ssr: false,
  loading: skel,
});
...
const FlashcardCreator = dynamic(
  () => import("../flashcards/flashcard-creator").then((mod) => mod.FlashcardCreator),
  { ssr: false, loading: skel },
);
const NoteCreator = dynamic(() => import("../notes/note-creator").then((mod) => mod.NoteCreator), {
  ssr: false,
  loading: skel,
});
