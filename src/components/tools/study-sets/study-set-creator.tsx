...
import { useFlashcardStorage } from "@/components/tools/flashcards/flashcard-creator";
import { useNoteStorage } from "@/components/tools/notes/note-creator";
			...
			<div className="space-y-2">
				...
				<div className="space-y-2">
					...
					<Button
						...
						size="sm"
						onClick={() => {
							// In a real implementation, this would open a flashcard picker dialog
							// For now, we'll just show a toast or alert
							alert("Flashcard picker would open here");
						}}
					>
						Add Flashcards
					</Button>
			...
			<div className="space-y-2">
				...
				<div className="space-y-2">
					...
					<Button
						...
						size="sm"
						onClick={() => {
							// In a real implementation, this would open a notes picker dialog
							alert("Notes picker would open here");
						}}
					>
						Add Notes
					</Button>
									...
									<div className="flex-1">
										...
										<div className="mt-1 flex items-center gap-1 text-xs">
											<span className="text-xs">
												{set.flashcardIds.length} flashcards •{" "}
												{set.noteIds.length} notes
											</span>
										</div>
									</div>
