        ...
        >
                ...
                {nextExams.map((exam) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="truncate font-medium text-xs">{exam.subject}</p>
                    ...
                    <div className="shrink-0 text-right">
                      <p className="font-medium text-xs tabular-nums">
                        {new Date(`${exam.date}T00:00:00`).toLocaleDateString("en-ZA", {
                          weekday: "short",
                          day: "numeric",
                          month: "short",
                        })}
          ...
          {grouped.length === 0 ? (
            <div className="flex flex-col items-center gap-2 rounded-2xl border border-border border-dashed py-12">
              <HugeiconsIcon icon={Calendar01Icon} className="size-8 text-muted-foreground/30" />
              <p className="text-muted-foreground/60 text-sm">No exam dates available yet</p>
            </div>
          ) : (
                        ...
                        >
                          ...
                          <div
                            className={cn(
                              ...
                              getSubjectColor(slot.subjectId).replace("bg-", "bg-"),
                            )}
                          >
                            <div
                              className={cn(
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="truncate font-medium text-xs">{slot.subject}</p>
                            <p className="ios-caption-3 text-muted-foreground">
                              Paper {slot.paperNumber} &middot; {formatDuration(slot.durationHours)}
                            </p>
                          </div>
                        </m.button>
                      ))}
