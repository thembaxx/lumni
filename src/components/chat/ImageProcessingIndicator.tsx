...
export function ImageProcessingIndicator({ state, onDismiss }: ImageProcessingIndicatorProps) {
        ...
        {isError ? (
          ...
          <>
            ...
            {state.status !== "success" && (
              <span className="text-muted-foreground text-xs tabular-nums">{state.progress}%</span>
            )}
          </>
        )}
      </div>
