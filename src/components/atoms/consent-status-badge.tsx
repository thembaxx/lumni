...
const consentStatusBadgeVariants = cva("gap-1.5 font-medium", {
  variants: {
    status: {
      granted: "border-success/30 bg-success/15 text-success hover:bg-success/20",
      pending: "border-warning/30 bg-warning/15 text-warning hover:bg-warning/20",
      revoked: "border-destructive/30 bg-destructive/15 text-destructive hover:bg-destructive/20",
    },
  },
  defaultVariants: {
    status: "pending",
...
interface ConsentStatusBadgeProps
  extends React.ComponentProps<typeof Badge>, VariantProps<typeof consentStatusBadgeVariants> {
