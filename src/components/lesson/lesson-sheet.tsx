...
import { Empty, EmptyDescription, EmptyTitle } from "@/components/shared/empty-state";
      ...
      <Anim>
        <SheetContent className="h-dvh w-full rounded-t-none px-4 sm:max-w-135" side="bottom">
          <SheetHeader className="text-left">
            ...
            <SheetDescription>Explore lessons across all subjects</SheetDescription>
          </SheetHeader>
          ...
          <div className="flex grow items-center gap-2 px-4 pb-6">
            ...
            >
              <Button variant="outline" size="sm" className="flex h-8 items-center gap-3">
          ...
          <div className="flex max-h-[calc(100dvh-var(--spacing-safe-pt)-var(--spacing-safe-pb))] grow flex-col gap-4 overflow-y-auto px-4 pb-4">
              ...
              <div className="flex flex-col gap-2">
                {(() => {
                  ...
                  for (let count = 0; count < 5; count++) {
                    items.push(<Skeleton key={`sk-${count}`} className="h-20 rounded-xl" />);
                  }
                  return items;
                })()}
              </div>
            ...
            {error && (
              <div className="py-8 text-center text-destructive text-sm" role="alert">
