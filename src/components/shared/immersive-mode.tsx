...
function ExitFullscreenButton({ onClick }: { onClick: () => void }) {
	return (
		<m.button
			...
			className="fixed top-3 right-3 z-modal flex items-center gap-1.5 rounded-full border border-border/60 bg-background/90 px-3 py-1.5 font-medium text-muted-foreground text-xs shadow-level-2 backdrop-blur-md"
