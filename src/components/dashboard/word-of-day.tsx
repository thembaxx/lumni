...
export function WordOfDayCard({ language = "en" }: WordOfDayCardProps) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col gap-2 rounded-2xl border border-border bg-card p-4 shadow-level-1 transition-[background-color,transform] duration-200 active:scale-[0.96]"
    >
