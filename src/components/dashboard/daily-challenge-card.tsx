    ...
    <Card>
      <CardContent className="p-5">
        <div className="flex items-center gap-4">
          <div className="relative flex size-12 shrink-0 items-center justify-center rounded-card bg-warning/15">
            <div className="absolute inset-0 animate-halo-pulse rounded-card" aria-hidden="true" />
            <HugeiconsIcon
              icon={SparklesIcon}
