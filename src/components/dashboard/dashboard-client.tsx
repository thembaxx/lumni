	...
	return (
		<div className="min-h-screen flex flex-col bg-[--system-grouped-background] pt-[--space-4] pb-[calc(var(--space-16)+var(--space-5))] overflow-hidden w-full">
			<div className="max-w-md mx-auto w-full">
				...
				<motion.div {...sectionProps(0.1)} className="mb-[--space-4] px-[--space-4]">
					<StatsCards
						streak={stats.streak}
				...
				<motion.div {...sectionProps(0.15)} className="mb-[--space-4] mx-[--space-4]">
				...
				<motion.div {...sectionProps(0.2)} className="mb-[--space-4] px-[--space-4]">
					<TodayFocusCard />
				</motion.div>

				<motion.div {...sectionProps(0.25)} className="mb-[--space-6] px-[--space-4]">
					<StudyTopicCardExample />
				</motion.div>

				<motion.div {...sectionProps(0.3)} className="space-y-[--space-4] w-full px-[--space-4] overflow-x-auto scrollbar-hide">
