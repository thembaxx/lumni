...
describe("BoltCelebration", () => {
  ...
  test("renders correct state with checkmark and XP", () => {
    const { container } = render(
      <BoltCelebration correct subjectLabel="Mathematics" streak={1} onContinue={() => {}} />,
    );
  ...
  test("shows streak badge when streak > 1 and adds bonus XP", () => {
    const { container } = render(
      <BoltCelebration correct subjectLabel="Mathematics" streak={5} onContinue={() => {}} />,
    );
  ...
  test("hides streak badge when streak is 1", () => {
    const { container } = render(
      <BoltCelebration correct={false} subjectLabel="Math" streak={1} onContinue={() => {}} />,
    );
  ...
  test("renders Continue button", () => {
    const { container } = render(
      <BoltCelebration correct subjectLabel="Math" streak={1} onContinue={() => {}} />,
    );
