...
function DropdownMenuContent({
  ...
  Pick<ListPrimitive.Positioner.Props, "align" | "alignOffset" | "side" | "sideOffset">) {
  return (
...
function DropdownMenuSeparator({ className, ...props }: ListPrimitive.Separator.Props) {
  return (
