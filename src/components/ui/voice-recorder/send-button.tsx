...
interface SendButtonProps {
  recorderState: "idle" | "recording" | "recorded" | "playing" | "sending" | "success";
  audioBlob: Blob | null;
  isTooShort: boolean;
  isTooLong: boolean;
  onSend: () => void;
...
export function SendButton({
  ...
  return (
    <Button
      onClick={onSend}
      disabled={
        isRecording || !audioBlob || isPaperPlaneing || sendSuccess || isTooShort || isTooLong
      }
      className={cn(
        ...
        sendSuccess
          ...
          : !isRecording && audioBlob && !isTooShort && !isTooLong
            ? "bg-(--system-accent) text-system-accent-foreground hover:opacity-90"
