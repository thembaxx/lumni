...
export function TopicMasteryHeatmap({ topics, className, ...props }: TopicMasteryHeatmapProps) {
  return (
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
          {topics.map((t) => (
            ...
            >
              ...
              <p className="text-muted-foreground text-xs">{t.studentCount} students</p>
            </div>
          ))}
          {topics.length === 0 && (
