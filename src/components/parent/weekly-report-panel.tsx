  ...
  return (
    <div className={cn("flex flex-col gap-4", className)} {...props}>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        />
        <StatCard icon={BookOpen01Icon} label="Quizzes Done" value={String(quizzesCompleted)} />
        <StatCard icon={Target01Icon} label="Streak" value={`${streakDays} days`} />
      </div>
...
function SubjectRow({ subject, score, topicsStudied, totalTopics }: SubjectProgress) {
  return (
    <Card className="p-4">
