...
describe("TopNav", () => {
  ...
  describe("TopNavMenu - authenticated user with dropdown", () => {
    ...
    it("calls signOut when Sign Out is clicked", () => {
      ...
      const signOutItem = Array.from(items).find((el) => el.textContent?.includes("Sign Out"));
      signOutItem?.click();
    ...
    it("navigates to settings on Settings click", () => {
      ...
      const settingsItem = Array.from(items).find(
        (el) => el.textContent?.includes("Settings") && !el.textContent?.includes("View Profile"),
      );
      settingsItem?.click();
    ...
    it("navigates to profile on View Profile click", () => {
      ...
      const { getAllByTestId } = render(<TopNav />);
      const items = getAllByTestId("dropdown-item");
      const profileItem = Array.from(items).find((el) => el.textContent?.includes("View Profile"));
      profileItem?.click();
