...
export function ConsentGate({
  ...
  if (status === "granted") {
    return (
      <Card className={cn("border-success/30 bg-success/5", className)} {...props}>
  ...
  return (
    <Card className={cn(className)} {...props}>
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          Before {parentEmail} can view {studentName}&apos;s progress, we need your consent.
        </CardDescription>
      </CardHeader>
      <CardContent className="flex flex-col gap-4">
        ...
        <div className="flex items-start gap-2">
          ...
          />
          <Label htmlFor="consent-agree" className="font-normal text-sm leading-relaxed">
            I am the legal guardian of {studentName} and I consent to sharing their study data with{" "}
            {parentEmail}.
          </Label>
        </div>
        <Button
