      ...
      <Dialog open={showSettings} onOpenChange={setShowSettings}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>{t("consent.cookieSettings.description")}</DialogDescription>
          </DialogHeader>
...
function CookieSettingsContent({
  ...
  onSave: (analytics: boolean, marketing: boolean, dataSharing: boolean) => void;
}) {
  const t = useTranslations();
  ...
  return (
    <div className="flex flex-col gap-4">
      <Field>
        <FieldLabel htmlFor="cookie-essential">{t("consent.cookieSettings.essential")}</FieldLabel>
      ...
      <Field>
        <FieldLabel htmlFor="cookie-analytics">{t("consent.cookieSettings.analytics")}</FieldLabel>
        <div className="flex items-center justify-between">
          <p className="text-muted-foreground text-sm">
      ...
      <Field>
        <FieldLabel htmlFor="cookie-marketing">{t("consent.cookieSettings.marketing")}</FieldLabel>
        <div className="flex items-center justify-between">
          <p className="text-muted-foreground text-sm">
      ...
      <Field>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="cookie-data-sharing" checked={dataSharing} onCheckedChange={setDataSharing} />
        </div>
      </Field>
      <Button onClick={() => onSave(analytics, marketing, dataSharing)} className="mt-2">
